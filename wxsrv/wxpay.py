...
class WeixinPay(object):
    ...
    def _fetch2(self, url, data, use_cert=False):
        data.setdefault("appid", self.app_id)
        data.setdefault("mch_id", self.mch_id)
        data.setdefault("nonce_str", self.nonce_str)
        data.setdefault("sign", self.signhmac(data))
    ...
    def pull_comment(self, begin_time, end_time, offset=0, limit=200, **data):
        """
        拉取评价
        ...
        return self._fetch2(url, data, True)